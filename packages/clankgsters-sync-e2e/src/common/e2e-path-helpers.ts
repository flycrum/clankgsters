...
export interface E2eTestCasePaths {
   ...
   * @example `caseConfigPath: '/repo/packages/clankgsters-sync-e2e/src/test-cases/basic/case-config.ts'` */
  caseConfigPath: string;
  /** Absolute path to the case directory that contains fixtures and config.
   * @example `caseDir: '/repo/packages/clankgsters-sync-e2e/src/test-cases/basic'` */
  caseDir: string;
