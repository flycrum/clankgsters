import { clankgstersConfigDefaults } from '../core/configs/clankgsters-config.defaults.js';
...
export const clankgstersIdentity = {
   ...
   */
  LOCAL_MARKETPLACE_NAME: clankgstersConfigDefaults.CONSTANTS.sourceDefaults.localMarketplaceName,
   ...
   */
  SYNC_CACHE_DIR: clankgstersConfigDefaults.CONSTANTS.syncCacheDir,
