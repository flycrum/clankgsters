...
export interface ProcessAgentBehaviorsMachineInput {
  ...
  behaviors: ClankgsterBehaviorConfig[];
   ...
   * @param behaviorName - Preset class name / {@link ClankgsterBehaviorConfig.behaviorName}.
  ...
  states: {
    ...
    processBehavior: {
      invoke: {
        ...
        input: ({ context }) => ({
          behaviorConfig: context.input.behaviors[context.index] as ClankgsterBehaviorConfig,
