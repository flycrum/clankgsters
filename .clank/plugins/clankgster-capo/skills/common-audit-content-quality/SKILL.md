---
name: common-audit-content-quality
description: >-
  ...
  quality", "review plugin write", "check prompt quality", "grade my plugin",
...
- Plugin structure or naming (use common-audit-plugin-structure)
- Link validity (use common-audit-internal-links / common-audit-external-links)
- Factual accuracy of claims (use common-audit-fact-check)
...
- [Skills write rules](../../rules/skills-write-rules.md) — skill file conventions
