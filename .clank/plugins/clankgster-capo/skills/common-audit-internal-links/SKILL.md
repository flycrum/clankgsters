---
name: common-audit-internal-links
description: >-
...
Scans all `.md` files in a single plugin directory. Checks only relative links (paths starting with `./`, `../`, or bare filenames) — not external URLs. For external URL checks, use common-audit-external-links.
