...
**Fix:** Link to the reference with a brief summary of what it covers. For prompt technique guidelines, see [common-prompt-techniques.md](common-prompt-techniques.md).
