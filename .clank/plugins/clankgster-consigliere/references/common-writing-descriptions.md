...
Write in **third person**. The description is injected into the system prompt alongside many other skill descriptions. Inconsistent point-of-view causes the agent to misinterpret the description.
...
- Contextual situations: "after editing plugins", "when rules are not updating"
