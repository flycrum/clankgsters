---
name: common-audit-external-links
description: >-
...
Scans all `.md` files in a single plugin directory. Checks only external links (`http://` and `https://`). For relative/internal link checks, use common-audit-internal-links.

## Out of scope

- Relative/internal links
- Content accuracy of linked pages (use common-audit-source-freshness)
