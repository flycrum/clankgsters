...
- Link accessibility (use common-audit-external-links)
- Source freshness comparison (use common-audit-source-freshness for URL-specific drift)
- Plugin structure or write quality
...
- [Content type comparison matrix](../../docs/common-content-type-comparison-matrix.md) — dense with factual claims, high-priority target
- [Prompt techniques](../../references/common-prompt-techniques.md) — contains technique references that may need verification
- [Tool calls](../../references/common-tool-calls.md) — tool availability claims to verify
