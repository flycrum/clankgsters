---
name: common-auditing-plugin-structure
description: >-
...
- Content quality (use common-auditing-content-quality)
- Link validity (use common-auditing-internal-links)
...
- [Writing skills](../../rules/common-writing-skills.md) — SKILL.md structure requirements
- [Writing descriptions](../../references/common-writing-descriptions.md) — description field criteria
