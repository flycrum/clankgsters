---
name: common-auditing-comparison-matrix
description: >-
...
- Other plugin files (use common-auditing-content-quality or common-auditing-fact-check for those)
- Matrix formatting or style (use common-auditing-content-quality)
- Plugin structure (use common-auditing-plugin-structure)
...
```
<plugin-path>/docs/common-content-type-comparison-matrix.md
```
...
- [Content type comparison matrix](../../docs/common-content-type-comparison-matrix.md) — the target file for this audit
- [Content type decision tree](../../docs/common-content-type-decision-tree.md) — related content type documentation
- [Tool calls](../../references/common-tool-calls.md) — platform-specific tool documentation
