---
name: common-auditing-source-freshness
description: >-
...
- Link accessibility (use common-auditing-external-links for that)
...
- [Prompt techniques](../../references/common-prompt-techniques.md) — techniques sourced from external documentation
- [Content type comparison matrix](../../docs/common-content-type-comparison-matrix.md) — heavily sourced from external docs, prime freshness candidate
