---
name: common-auditing-content-quality
description: >-
...
- Plugin structure or naming (use common-auditing-plugin-structure)
- Link validity (use common-auditing-internal-links / common-auditing-external-links)
- Factual accuracy of claims (use common-auditing-fact-check)
...
- [Writing descriptions](../../references/common-writing-descriptions.md) — description field evaluation criteria
- [Writing rules](../../rules/common-writing-rules.md) — rule file conventions
- [Writing skills](../../rules/common-writing-skills.md) — skill file conventions
