---
name: common-auditing-fact-check
description: >-
...
- Link accessibility (use common-auditing-external-links)
- Source freshness comparison (use common-auditing-source-freshness for URL-specific drift)
