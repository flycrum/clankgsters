---
name: common-audit-comparison-matrix
description: >-
...
- Other plugin files (use common-audit-content-quality or common-audit-fact-check for those)
- Matrix formatting or style (use common-audit-content-quality)
- Plugin structure (use common-audit-plugin-structure)
