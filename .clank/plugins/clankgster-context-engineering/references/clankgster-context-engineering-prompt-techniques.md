...
See [clankgster-context-engineering-tool-calls.md](clankgster-context-engineering-tool-calls.md) for the complete tool reference across Claude Code, Cursor, and Codex.
