...
Scans all `.md` files in a single plugin directory. Checks only external links (`http://` and `https://`). For relative/internal link checks, use auditing-internal-links.

## Out of scope

- Relative/internal links
- Content accuracy of linked pages (use auditing-source-freshness)
...
- [Prompt techniques](../../references/clankgster-context-engineering-prompt-techniques.md) — source URLs referenced in plugin content
