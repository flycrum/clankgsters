...
Scans all `.md` files in a single plugin directory. Checks only relative links (paths starting with `./`, `../`, or bare filenames) — not external URLs. For external URL checks, use auditing-external-links.
...
- [Progressive disclosure](../../references/clankgster-context-engineering-progressive-disclosure.md) — cross-reference layering patterns
- [Organizing plugin content](../../rules/clankgster-context-engineering-organizing-plugin-content.md) — expected directory structure for path resolution
