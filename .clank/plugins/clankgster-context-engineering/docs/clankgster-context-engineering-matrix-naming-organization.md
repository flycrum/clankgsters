...
**Docs** use plugin-prefix plus a topic name: `clankgster-context-engineering-deep-research-report.md`. Docs live in `docs/` and are not synced to agent directories.
