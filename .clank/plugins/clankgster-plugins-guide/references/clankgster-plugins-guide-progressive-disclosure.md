...
- See [clankgster-plugins-guide-writing-descriptions.md](clankgster-plugins-guide-writing-descriptions.md)
...
**Fix:** Link to the reference with a brief summary of what it covers. "For prompt technique guidelines, see [prompt-techniques.md](../../references/clankgster-plugins-guide-prompt-techniques.md)."
