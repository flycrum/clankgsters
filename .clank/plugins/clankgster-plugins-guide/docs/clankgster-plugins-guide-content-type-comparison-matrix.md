...
## [Loading and context behavior](clankgster-plugins-guide-matrix-loading-behavior.md)
...
## [Invocation and triggering](clankgster-plugins-guide-matrix-invocation-triggering.md)
...
## [Metadata and frontmatter](clankgster-plugins-guide-matrix-metadata-frontmatter.md)
...
## [Content guidelines](clankgster-plugins-guide-matrix-content-guidelines.md)
...
## [Naming and organization](clankgster-plugins-guide-matrix-naming-organization.md)
...
## [Cross-agent support](clankgster-plugins-guide-matrix-cross-agent-support.md)
