...
Targets the specific file `docs/clankgster-plugins-guide-content-type-comparison-matrix.md` within the clankgster-plugins-guide plugin. Also checks any 1:1 docs files the matrix links to.
...
```
<plugin-path>/docs/clankgster-plugins-guide-content-type-comparison-matrix.md
```
...
- [Content type comparison matrix](../../docs/clankgster-plugins-guide-content-type-comparison-matrix.md) — the target file for this audit
- [Content type decision tree](../../docs/clankgster-plugins-guide-content-type-decision-tree.md) — related content type documentation
- [Tool calls](../../references/clankgster-plugins-guide-tool-calls.md) — platform-specific tool documentation
