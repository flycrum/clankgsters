...
- [Progressive disclosure](../../references/clankgster-plugins-guide-progressive-disclosure.md) — cross-reference layering patterns
- [Organizing plugin content](../../rules/clankgster-plugins-guide-organizing-plugin-content.md) — expected directory structure for path resolution
