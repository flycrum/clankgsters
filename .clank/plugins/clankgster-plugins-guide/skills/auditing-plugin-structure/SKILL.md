...
- [Organizing plugin content](../../rules/clankgster-plugins-guide-organizing-plugin-content.md) — canonical content type placement rules
- [Writing skills](../../rules/clankgster-plugins-guide-writing-skills.md) — SKILL.md structure requirements
