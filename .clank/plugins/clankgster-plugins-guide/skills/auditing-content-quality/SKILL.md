...
- [Prompt techniques](../../references/clankgster-plugins-guide-prompt-techniques.md) — quality criteria for emphasis, XML tags, framing, examples
- [Writing descriptions](../../references/clankgster-plugins-guide-writing-descriptions.md) — description field evaluation criteria
- [Writing rules](../../rules/clankgster-plugins-guide-writing-rules.md) — rule file conventions
- [Writing skills](../../rules/clankgster-plugins-guide-writing-skills.md) — skill file conventions
