...
- [Prompt techniques](../../references/clankgster-plugins-guide-prompt-techniques.md) — techniques sourced from external documentation
- [Content type comparison matrix](../../docs/clankgster-plugins-guide-content-type-comparison-matrix.md) — heavily sourced from external docs, prime freshness candidate
